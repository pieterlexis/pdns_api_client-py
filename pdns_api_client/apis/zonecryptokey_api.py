...
class ZonecryptokeyApi(object):
    ...
    def create_crypto_key(self, server_id, zone_id, cryptokey, **kwargs):
        """
        Creates a Cryptokey
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_crypto_key(server_id, zone_id, cryptokey, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_crypto_key_with_http_info(server_id, zone_id, cryptokey, **kwargs)
        else:
            (data) = self.create_crypto_key_with_http_info(server_id, zone_id, cryptokey, **kwargs)
            return data

    def create_crypto_key_with_http_info(self, server_id, zone_id, cryptokey, **kwargs):
        """
        Creates a Cryptokey
        This method adds a new key to a zone. The key can either be generated or imported by supplying the content parameter. if content, bits and algo are null, a key will be generated based on the default-ksk-algorithm and default-ksk-size settings for a KSK and the default-zsk-algorithm and default-zsk-size options for a ZSK.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_crypto_key_with_http_info(server_id, zone_id, cryptokey, callback=callback_function)
        ...
        if ('cryptokey' not in params) or (params['cryptokey'] is None):
            raise ValueError("Missing the required parameter `cryptokey` when calling `create_crypto_key`")
    ...
    def list_crypto_keys(self, server_id, zone_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_crypto_keys(server_id, zone_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_crypto_keys_with_http_info(server_id, zone_id, **kwargs)
        else:
            (data) = self.list_crypto_keys_with_http_info(server_id, zone_id, **kwargs)
            return data

    def list_crypto_keys_with_http_info(self, server_id, zone_id, **kwargs):
        """
        Get all CryptoKeys for a zone, except the privatekey
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_crypto_keys_with_http_info(server_id, zone_id, callback=callback_function)
        ...
        # verify the required parameter 'server_id' is set
        if ('server_id' not in params) or (params['server_id'] is None):
            raise ValueError("Missing the required parameter `server_id` when calling `list_crypto_keys`")
        # verify the required parameter 'zone_id' is set
        if ('zone_id' not in params) or (params['zone_id'] is None):
            raise ValueError("Missing the required parameter `zone_id` when calling `list_crypto_keys`")
