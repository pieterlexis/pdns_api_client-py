...
class RRSet(object):
    ...
    def __init__(self, name=None, type=None, ttl=None, changetype=None, records=None, comments=None):
        """
        RRSet - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this RRSet.
        Name for record set (e.g. “www.powerdns.com.”)

        :return: The name of this RRSet.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this RRSet.
        :type: str
        """
        if name is None:
    ...
    def type(self, type):
        ...
        :param type: The type of this RRSet.
        :type: str
        """
        if type is None:
    ...
    def ttl(self, ttl):
        ...
        :param ttl: The ttl of this RRSet.
        :type: int
        """
        if ttl is None:
    ...
    def changetype(self):
        """
        Gets the changetype of this RRSet.
        ...
        :return: The changetype of this RRSet.
        :rtype: str
        """
    ...
    def changetype(self, changetype):
        ...
        :param changetype: The changetype of this RRSet.
        :type: str
        """
        if changetype is None:
            raise ValueError("Invalid value for `changetype`, must not be `None`")
    ...
    def records(self):
        """
        Gets the records of this RRSet.
        ...
        :return: The records of this RRSet.
        :rtype: list[Record]
        """
    ...
    def records(self, records):
        ...
        :param records: The records of this RRSet.
        :type: list[Record]
        """
        if records is None:
    ...
    def comments(self):
        """
        Gets the comments of this RRSet.
        ...
        :return: The comments of this RRSet.
        :rtype: list[Comment]
        """
    ...
    def comments(self, comments):
        ...
        :param comments: The comments of this RRSet.
        :type: list[Comment]
        """
