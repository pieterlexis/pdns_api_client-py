...
*ZonecryptokeyApi* | [**create_crypto_key**](docs/ZonecryptokeyApi.md#create_crypto_key) | **POST** /servers/{server_id}/zones/{zone_id}/cryptokeys | Creates a Cryptokey
...
*ZonecryptokeyApi* | [**list_crypto_keys**](docs/ZonecryptokeyApi.md#list_crypto_keys) | **GET** /servers/{server_id}/zones/{zone_id}/cryptokeys | Get all CryptoKeys for a zone, except the privatekey
