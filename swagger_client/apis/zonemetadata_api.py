...
class ZonemetadataApi(object):
    ...
    def modify_zone_metadata_kind(self, server_id, zone_id, metadata, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.modify_zone_metadata_kind(server_id, zone_id, metadata, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.modify_zone_metadata_kind_with_http_info(server_id, zone_id, metadata, **kwargs)
        else:
            (data) = self.modify_zone_metadata_kind_with_http_info(server_id, zone_id, metadata, **kwargs)
            return data

    def modify_zone_metadata_kind_with_http_info(self, server_id, zone_id, metadata, **kwargs):
        """
        Modify the content of a single kind of domain metadata.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.modify_zone_metadata_kind_with_http_info(server_id, zone_id, metadata, callback=callback_function)
