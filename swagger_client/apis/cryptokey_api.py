...
class CryptokeyApi(object):
    ...
    def create_crypto_key(self, server_id, zone_id, metadata, **kwargs):
        ...
        :param list[Cryptokey] metadata: List of metadata to add/create (required)
        :return: None
    ...
    def modify_cryptokey(self, server_id, zone_id, cryptokey_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.modify_cryptokey(server_id, zone_id, cryptokey_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str server_id: The id of the server to retrieve (required)
        :param str zone_id: (required)
        :param list[Cryptokey] cryptokey_id: Cryptokey to manipulate (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.modify_cryptokey_with_http_info(server_id, zone_id, cryptokey_id, **kwargs)
        else:
            (data) = self.modify_cryptokey_with_http_info(server_id, zone_id, cryptokey_id, **kwargs)
            return data

    def modify_cryptokey_with_http_info(self, server_id, zone_id, cryptokey_id, **kwargs):
        """
        This method (de)activates a key from zone_name specified by cryptokey_id
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.modify_cryptokey_with_http_info(server_id, zone_id, cryptokey_id, callback=callback_function)
        ...
        body_params = None
        if 'cryptokey_id' in params:
            body_params = params['cryptokey_id']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
